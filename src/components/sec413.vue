    ...
    <div class="gh d-flex flex-column justify-content-center align-items-center ">
       <div class="gz bottom24 d-flex flex-column justify-content-center align-items-center ">
           <div class="w-100 gf2 d-flex flex-column">
               <p class="ga">Atenção alérgicos</p>
               <p class="gw">Pó de giz e pó de carvão quando inalados podem agravar alergias respiratórias e quadros de rinite, sinusite e bronquite – tenha cuidado com esses materiais em ambientes frequentados por crianças, pessoas alérgicas e animais.
