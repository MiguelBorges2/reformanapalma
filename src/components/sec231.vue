            ...
            <div class="w-100 d-flex flex-column justify-content-center align-items-center">
                ...
                <div @click="changes3()"  class="d-flex tcs flex-column  justify-content-center align-items-center">
                    ...
                    <div class="tugali d-flex flex-column justify-content-center align-items-center" v-if="togi3 === true">
                        ...
                        <img class="tamanho81" src="@/assets/IMG 3 3.svg" alt="Logo2">
                        <img class="tamanho81" src="@/assets/IMG 3 4.svg" alt="Logo2">
                        <img class="tamanho81" src="@/assets/IMG 6 4.svg" alt="Logo2">
                        <img class="tamanho81" src="@/assets/IMG 6 3.svg" alt="Logo2">
                        <img class="tamanho81" src="@/assets/IMG 4 3.svg" alt="Logo2">
                        <img class="tamanho81" src="@/assets/IMG 4 4.svg" alt="Logo2">
                        <img class="tamanho82" src="@/assets/GIF - Quarto para uma pessoa - Móveis.gif" alt="Logo2">
                    </div>
                </div>    
