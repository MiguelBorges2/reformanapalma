...
.overlay {
    ...
    right: 0;
    bottom: 0;
    background-color: rgba(0, 0, 0, 0.5);  /* Fundo opaco (transparente) */
    z-index: 999; /* Garantir que o fundo fique acima de outros elementos */
}
 .yip4 {
        font-size: 3vw;
    }   
 ...
 .cor {
        background:   #749695; /* Ajuste as cores conforme necessário */
